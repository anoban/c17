// https://github.com/NormanDunbar/HexDump/tree/master
...
** 07 Dec 2016 : Norman Dunbar :
 * Amended
 * to

 * *

 * * allow hex values for start and count.
**                               Don't duplicate last line if address
 * exact
 * multiple
 * of 16.
**
 ...
 * * fseek() instead of manually skipping to "start".
*/
...
void static dodump(FILE* fp, long start, long count);
